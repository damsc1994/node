...
test.serial.cb('/api/agents', t => {
    ...
    request(server).get('/api/agents').expect(200).expect('content-type', /json/).end((err, res) => {
        ...
        t.deepEqual(body, AgentFixture.find, 'api/agents no trajo los datos esperados');
        t.end();
    });
});
//# sourceMappingURL=/Users/damsc94/Documents/desarollo/pruebas-javascrit/node/platziserve/platziserve-api/node_modules/.cache/ava/011b5c39d93d0d8b430ed3fb002049ff.js.map