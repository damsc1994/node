...
test.serial.cb('/api/agents', t => {
    request(server).get('/api/agents').expect(200).expect('Content-type', /json/).expect((err, res) => {
        var _rec = new _powerAssertRecorder();

        t.false(_rec._expr(_rec._capt(err, 'arguments/0'), {
            content: 't.false(err, \'Hubo un error en api/agents\')',
            filepath: 'test/api-test.js',
            line: 13,
            ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"false","range":[2,7]},"computed":false,"range":[0,7]},"arguments":[{"type":"Identifier","name":"err","range":[8,11]},{"type":"StringLiteral","value":"Hubo un error en api/agents","range":[13,42]}],"range":[0,43]}',
            tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"false"},"value":"false","range":[2,7]},{"type":{"label":"("},"range":[7,8]},{"type":{"label":"name"},"value":"err","range":[8,11]},{"type":{"label":","},"range":[11,12]},{"type":{"label":"string"},"value":"Hubo un error en api/agents","range":[13,42]},{"type":{"label":")"},"range":[42,43]}]',
            visitorKeys: _powerAssertVisitorKeys
        }), 'Hubo un error en api/agents');
        t.deepEqual(res, {}, 'api/agents no trajo los datos esperados');
    });
});
//# sourceMappingURL=/Users/damsc94/Documents/desarollo/pruebas-javascrit/node/platziserve/platziserve-api/node_modules/.cache/ava/37b4b9ddef6f3b491b06e19ea0b6fd72.js.map