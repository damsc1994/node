...
test.serial.cb('/api/agents', t => {
    ...
    request(server).get('/api/agents').expect(200).expect('content-type', /json/).end((err, res) => {
        ...
        t.deepEqual(body, AgentFixture.agents, 'api/agents no trajo los datos esperados');
        t.end();
    });
});
//# sourceMappingURL=/Users/damsc94/Documents/desarollo/pruebas-javascrit/node/platziserve/platziserve-api/node_modules/.cache/ava/8c86d92316347deacbb5ede84fbb4321.js.map