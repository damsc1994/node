...
test.beforeEach(async () => {
    ...
    token = sign({ admin: true, username: 'admin' }, 'platzi', console.log);
...
test.serial.cb('/api/agents', t => {
    debug('test');
    request(server).get('/api/agents').expect(200).set('Content-type', `Bearer ${token}`).expect('content-type', /json/).end((err, res) => {
...
//# sourceMappingURL=/Users/damsc94/Documents/desarollo/pruebas-javascrit/node/platziserve/platziserve-api/node_modules/.cache/ava/0397a74174f02888ad9ce2c4780b08c2.js.map