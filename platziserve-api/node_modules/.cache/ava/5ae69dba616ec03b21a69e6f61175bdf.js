...
test.serial.cb('/api/agents', t => {
    ...
    request(server).get('/api/agents').expect(200).expect('content-type', /json/).end((err, res) => {
        ...
        let body = JSO.stringify(res.body);
        const expected = JSON.stringify(AgentFixture.findByConected());
        ...
        t.deepEqual(body, expected, 'api/agents no trajo los datos esperados');
        t.end();
    });
});
...
//# sourceMappingURL=/Users/damsc94/Documents/desarollo/pruebas-javascrit/node/platziserve/platziserve-api/node_modules/.cache/ava/5ae69dba616ec03b21a69e6f61175bdf.js.map